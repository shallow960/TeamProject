...
const routes = {
  ...
  admin: {
    ...
    dashboard: { path: "/admin", label: "관리자 홈" },
    password: { path: "/admin/updatePw", label: "관리자 비밀번호 변경" }, //안형주 추가
    members: { path: "/admin/membersList", label: "회원 관리" },
